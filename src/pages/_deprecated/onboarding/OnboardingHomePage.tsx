...
import { ArrowRightIcon, ArrowRightOnRectangleIcon, PlusIcon } from '@heroicons/react/20/solid'
...
export type OnboardingHomePageProps =
  | {
      isOnboarding: true
      steps: Steps
    }
...
export const OnboardingHomePage = withBrowserBundle((props: OnboardingHomePageProps) => {
      ...
      <div className='flex items-center mt-3'>
        ...
        {/* <form method='POST' className='ml-2'>
          ...
          <button type='submit' className={`${secondaryButtonStyles}`}>
            <ArrowRightOnRectangleIcon className={`${buttonIconStyles}`} />
            Ignorer tous les autres visages
          </button>
        </form> */}
      </div>
      <div className='text-gray-500 mt-1'>Vous pourrez les annoter plus tard.</div>
    </>
  )
}
